...
$(function() {
    ...
    var options = {
        center: {lat: 25.77759, lng: -80.191225}, // Idea Center, Miami, FLorida
...
function addMarker(place)
{
    ...
    // get marker postal code
    var parameters = {
        geo: place.postal_code
    };
     
     // when marker clicked get news feed
     google.maps.event.addListener(marker, "click", function() {  
        $.getJSON("articles.php", parameters)
        .done(function(data, textStatus, jqXHR) {
        
            // create an unordered list of news feed with links
            var list = '<ul>';
